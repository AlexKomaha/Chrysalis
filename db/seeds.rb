...
User.all.each do |user|
  ...
  (1..20).each do |num|
    ...
    puts "#{Emotion.count} emotions created"
  end
  ...
  UserGoal.create!(description: "Call Naoya and see if he wants to come over.", status: "active", user: user)
